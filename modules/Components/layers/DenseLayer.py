...
class DenseLayer(IDL.Layer_Interface):
        def __init__(self, 
                     input_units: int, 
                     output_units: int, 
                     activation_function: IDL.Function_Interface,
                     weights_initializer: IDL.Initializer_Interface,
                     biases_initializer: IDL.Initializer_Interface) -> None:
                super().__init__(input_units, output_units, activation_function, weights_initializer, biases_initializer)    
